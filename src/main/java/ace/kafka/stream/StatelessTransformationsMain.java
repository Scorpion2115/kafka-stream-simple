...
public class StatelessTransformationsMain {
    ...
    public static void main(String[] args) {
        ...
        // use source.branch and it returns an array of K streams
        KStream<String, String>[] branches = source.branch((key, value) -> key.startsWith("a"), (key, value) -> true);
        //assign these two elements in my array to two variables
        ...
        //Foreach
        // It is a terminal operation, we can't add any additional steps after that
